  ...
  >
    <div class="modal">
      ...
      <div class="modal-content">
        <p v-if="isDisabled" class="error">
          You have disabled keyboard shortcuts in the options.
        </p>
        ...
        <div style="text-align: center">
          <a v-on:click="openSettings()"
            >Change keyboard combinations in options</a
          >
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    fetchOptions: function () {
      ...
      this.keybindToggleRecDiag = keyboardShortcuts.printableKey(
        Options.get("keybindToggleRecDiag"),
      );
      this.keybindRestorePreviousSession = keyboardShortcuts.printableKey(
        Options.get("keybindRestorePreviousSession"),
      );
      this.keybindOpenQuickAccess = keyboardShortcuts.printableKey(
        Options.get("keybindOpenQuickAccess"),
      );
    },
    openSettings: function () {
      chrome.runtime.sendMessage({
        action: "openSettings",
        hash: "#/options#keyboard-shortcuts",
      });
    },
    closeModal: function () {
      this.visible = false;
