<template>
  <div class="keyboard-shortcut-picker" @click="emitResponse('cancel')">
    <p class="big">
      {{
        pressedKeys.join(" + ") || "Enter keyboard combination on your keyboard"
      }}
    </p>

    <div class="actions">
      <button @click="emitResponse('disable') && $event.stopPropagation()">
        Disable keyboard shortcut
      </button>
      <button @click="emitResponse('reset') && $event.stopPropagation()">
        Reset to default
      </button>
      <button @click="emitResponse('cancel') && $event.stopPropagation()">
        Cancel
      </button>
    </div>
  </div>
