...
(function(options, saveIndicator, editableManager, Events, initHandler) {
	...
	function makeVue(rootnode, callback) {
		vue = new Vue({
			...{render: function render() {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _vm._m(0)}, staticRenderFns: [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"title":"This is the save indicator for Typio Form Recovery. Disable or change indicator style in the settings.","id":"save-indicator"}},[_c('div',{staticClass:"animator"})])}]},
			el: rootnode,
			methods: {
				show: function() {
					this.isVisible = true;
