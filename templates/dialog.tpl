			...
			<div class="content">
				...
				<div class="content-partial partial-settings">
					<div class="inner-content">
						...
						<p><a href="#" data-action="add-to-blacklist">Disable Typio on this site</a></p>
				...
				<div class="content-partial partial-default partial-current">
					<div class="centered">
						...
						<p class="hint">Psst. Do you know about the <a data-action="show-shortcuts">keyboard shortcuts?</a></p>
					</div>
				</div>
			</div>
